...
urlpatterns = [
    ...
    path('solicitar_troca_email/', views.solicitar_troca_email, name='solicitar_troca_email'),
    path('confirmar_troca_email/<str:token>/', views.confirmar_troca_email, name='confirmar_troca_email'),
