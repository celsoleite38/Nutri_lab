...
def detalhe_solicitacao(request, solicitacao_id):
    ...
    # Adicionar um novo exame à solicitação (sem resultado ainda)
    ...
    # Atualizar resultados recebidos
...
def imprimir_solicitacao(request, solicitacao_id):
    ...
    try:
        perfil_profissional = PerfilProfissional.objects.get(usuario=request.user)
