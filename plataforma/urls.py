...
urlpatterns = [
    ...
    path('api/sugerir-substituicoes/<int:item_id>/', views.sugerir_substituicoes, name='sugerir_substituicoes'),
    path('refeicao/item/substituicoes/salvar/<int:item_id>/', views.salvar_substituicoes, name='salvar_substituicoes'),
